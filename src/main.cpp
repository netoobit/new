...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    else if(pindexBest->nHeight <= 25500)
    {
        nSubsidy = 500 * COIN;
    }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("042732ed114f00cce825318704e698aa03ba6abd9d88f3f8c48fd5f4c2bad94920e1d0890c26278c7e09ed0b19dc0ce491b2e81afadb25586accca4810f8329a7f");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2016 Gravity is now known as something different";
        CTransaction txNew;
        txNew.nTime = 1453904732;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1453904732;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 497917;

        assert(block.hashMerkleRoot == uint256("0xeebdfd9721c24b3e6abe00229290b419f896542d29eb83044be01c8383919716"));
    ...
    string strPubKey = "0428924f8110fe4485342c9eaf468d5570c7daa98d6c8967b39cc35b7629870e16bd40ac4ed4d72947f9572921f5761752ff852706512a7df3fa38c8d840252cc4";
